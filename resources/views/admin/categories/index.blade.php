...
@section('content')
	<div class="bgC5">
		<div class="pV30 pH10" id="adminEditMenu">
			...
			<button id="createCategoryBtn" data-toggle="modal" data-target="#editCategoryFormModal" rel="nofollow" class="btn btn-sm btn-success" title="Create new category">Pridať kategóriu</button>
